...
You can use a slice in another slice's [Effect](/docs/guide/effects/):
...
For more information on using slices in React components, see [usage with React](/docs/guide/react/).
