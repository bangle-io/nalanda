...
Also read [key.field](/docs/api/key#field) or [Fields guide](/docs/guide/fields#state-fields).
...
<Callout type="info">
    It is recommended that you use actions to update state fields instead. See [Actions](/docs/guide/actions) for more information.
</Callout>