...
export function StoreProvider({
  ...
  useEffect(() => {
    ...
    store.options.slices.forEach((slice) => {
      ...
      if (existing) {
        throw new Error(
          `Cannot create a context store with a slice that is already associated with another store. Please see https://nalanda.bangle.io/docs/common-errors/#store-context`,
        );
      }
